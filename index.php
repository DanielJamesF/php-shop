...
<body>
    ...
    <div class="container">
        <div class="user-profile">
            ...
            <p> username: <span><?php echo $fetch_user['email']; ?></span></p>
            <div class="flex">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr class="table-bottom">
                        ...
                        <td><a href="index.php?delete_all" onclick="return comfirm('delete all from cart?');" class="delete-btn <?php echo ($grand_total > 1)? '':'disabled'; ?>">delete all</a></td>
                    </tr>
                </tbody>
            </table>
            <div class="cart-btn">
